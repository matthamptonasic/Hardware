...
###############################################################################
*/
#ifndef TYPEBASE_FOURSTATE_H
#define TYPEBASE_FOURSTATE_H
...
class TypeBase_FourState : TypeBase
{
  // Enums
  public:
  ...
  // Constructors
  public:
    TypeBase_FourState(string iFullName);
